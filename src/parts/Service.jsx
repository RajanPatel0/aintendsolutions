      ...
      <div className="container mx-auto pt-5 pb-5">
        ...
        <Fade direction="left" triggerOnce>
          <p className="font-light text-lg text-gray-400 text-center mb-12">
            We are ready to scale up your business with our great service & tools.
          </p>
        </Fade>

        <div className="grid grid-rows-2 grid-cols-2 px-10 gap-8 sm:grid-cols-4 sm:grid-rows-1 sm:gap-6 xl:gap-16">
          {
            data.map((item, index) => (
