  ...
  return (
    <section className="hero">
      <div className="w-full lg:w-1/2 xl:pl-12 sm:pr-2 mt-8">
        ...
        <p className="font-light text-xl text-gray-400 leading-relaxed mb-6">
          We provide softwares, web tools, developers & designers using latest technologies to help
      ...
      <div className="flex pt-0 md:w-fit w-full justify-center items-center order-first md:order-first lg:order-last lg:w-1/2">
